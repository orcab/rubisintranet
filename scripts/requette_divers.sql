...
-- passage des bon du jour livrés en LIV
...
-- passe les produits CAB56 et BERNER à non servis sur stock
...
-- pour les articles créer depuis plus d'un an en class E ou F, on passe en préco à NON
...
-- pour les articles en class entre A et D --> achat autorisé
...
-- pour les articles créer  depuis plus d'un anet en class inférieur a E --> achat interdit
