...
define('DESIGNATION_DEVIS_WIDTH',PAGE_WIDTH - LEFT_MARGIN - RIGHT_MARGIN - (REF_WIDTH + FOURNISSEUR_WIDTH + UNITE_WIDTH + QTE_WIDTH + PUHT_WIDTH + PTHT_WIDTH + TYPE_CDE_WIDTH + DISPO_WIDTH + LIVRE_WIDTH) ); // s'appadate à la largeur de la page
...
class PDF extends FPDF
{
	...
	{	global $row_entete,$SOCIETE,$info_user ;
		...
		// Référence
		$this->SetFont('helvetica','',11);
		$this->Cell(50, 5 ,"Réf : $row_entete[reference]");
		$this->Ln();
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(0,5,"S=Spécial, D=Dispo, L=Livré",0,1,'R');
		$this->Ln(1);
