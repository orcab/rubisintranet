...
where	
	...
	and CONCAT(DTBOS,CONCAT(DTBOA,CONCAT(DTBOM,DTBOJ))) <= '$now'
	and CONCAT(DTBOS,CONCAT(DTBOA,CONCAT(DTBOM,DTBOJ))) > '$date_precedente'
...
// entête de mail
$html .= "<b>Liste des Acus&eacute; de r&eacute;ception de $row[nom] $date_affichable</b><br/><br/>";
