...
$sql_detail = <<<EOT
select CDE_ENTETE.NOBON,DTBOS,DTBOA,DTBOM,DTBOJ,LIVSB,RFCSB,DLSSB,DLASB,DLMSB,DLJSB,NOLIG,TYCDE,CODAR,DS1DB,DS2DB,DS3DB,CONSA,QTESA,NOMFO,REFFO,PRINE,CDE_DETAIL.MONHT,CDE_ENTETE.MONTBT,CDE_ENTETE.AGENC
