...
$sql_detail = <<<EOT
select CDE_ENTETE.NOBON,DTBOS,DTBOA,DTBOM,DTBOJ,LIVSB,RFCSB,DLSSB,DLASB,DLMSB,DLJSB,NOLIG,TYCDE,CODAR,DS1DB,DS2DB,DS3DB,CONSA,QTESA,NOMFO,REFFO,PRINE,CDE_DETAIL.MONHT,CDE_ENTETE.MONTBT,CDE_ENTETE.AGENC,CHANTIER.CHAD1
...
where	
	...
	and CONCAT(DTLIS,CONCAT(DTLIA,CONCAT(DTLIM,DTLIJ))) <= '$now'
	and CONCAT(DTLIS,CONCAT(DTLIA,CONCAT(DTLIM,DTLIJ))) > '$date_precedente'
...
// entête de mail
$html .= "<b>Liste des Bon de Livraison de $row[nom] $date_affichable</b><br/><br/>";
