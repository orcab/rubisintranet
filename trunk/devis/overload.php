...
class PDF extends FPDF
{
	...
	{	global $values,$SOCIETE,$options ;
		...
		$this->Cell(90, 5 ,$values['artisan.nom']);
		
		// nom Client
		$this->SetFont('helvetica','',11);
		$this->Cell(60, 5 ,$values['client.nom']);
		$this->Ln();
		...
		$this->SetFont('helvetica','',11);
		$this->Cell(90, 5 ,$values['artisan.representant']);

		// client adresse 1
		$this->SetFont('helvetica','I',11);
		$this->Cell(90, 5 ,$values['client.adresse']);
		$this->Ln();

		// client adresse 2
		$this->Cell(121);
		$this->Cell(60, 5 ,$values['client.adresse2']);
		$this->Ln();

		// client CP
		$this->SetFont('helvetica','',11);
		$this->Cell(111);
		$this->Cell(13, 5 ,$values['client.codepostal']);

		// client ville
		$this->Cell(60, 5 ,$values['client.ville']);
		$this->Ln();

		// N° de bon
		$this->SetFont('helvetica','B',11);
		$this->Cell(34, 5 ,"BON DE CHOIX n°");
		$this->Cell(77, 5 ,$values['devis.numero']);

		// client tel 1
		$this->Cell(60, 5 ,$values['client.telephone']);
		$this->Ln();

		// Date de création du devis
		$this->SetFont('helvetica','',10);
		$this->Cell(15, 5 ,"Devis du ");
		$this->Cell(77, 5 ,$values['devis.date']);

		// client tel 2
		$this->Cell(19);
		$this->Cell(60, 5 ,$values['client.telephone2']);
		$this->Ln();
		...
		$this->SetFont('helvetica','',10);
		$this->Cell(21);
		$this->Cell(60, 5 ,$values['client.email']);
		$this->Ln(6);
	...
	{	global $values,$SOCIETE ;
		...
		$this->SetFont('helvetica','',9);
		$this->Cell(0,4,'Edition du '.$values['devis.date_maj'].' à '.$values['devis.heure_maj'],0,1,'C');
