...
EOT;
	...
	$worksheet->write(0,DESIGNATION, 		'Désigantion',$format_title); $worksheet->setColumn(DESIGNATION,DESIGNATION,30);
	...
	$worksheet->write(0,REMISE_VENIR,		'Reimse futur',$format_title);
