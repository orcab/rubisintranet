...
class PDF extends FPDF
{
	...
	function Footer() {
		...
		// qrcode du fichier
		$json = array('t'=>(BON_DE_RETOUR ? 'bon_retour':'bon_preparation'),'b'=>$row_entete['NOBON'],'c'=>$row_entete['NOCLI'],'d'=>time(),'p'=>$this->PageNo());
		...
		$this->Cell(0,5,'Edition du '.date('d/m/Y H:i').(isset($arguments['user']) && $arguments['user'] ? " par $arguments[user]":''),0,1,'C');
