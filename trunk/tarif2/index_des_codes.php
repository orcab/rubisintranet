<?
// PAGE DES INDEX DES CODE MCS !!!

// construction de l'index des references
ksort($CODE_MCS,SORT_STRING);
$titre_page = "Index des codes MCS";
...
foreach($CODE_MCS as $ref=>$data) {
	if ($ref) {
		...
		if ($ligne == 0) { // sur un entete
			...
			$pdf->Cell(INDEX_REF_WIDTH,INDEX_CELL_HEIGHT,'Code MCS','BR',0,'L'); // ref
