...
class PDF extends FPDF
{
	...
	{	global $values,$SOCIETE,$options,$_POST,$id_devis,$date ;
		...
		elseif ($_POST['artisan_nom'] == 'CAB 56')
			...
			$this->Cell(90, 5 , my_utf8_decode($_POST['artisan_nom']) );
		
		// nom Client
		$this->SetFont('helvetica','',11);
		$this->Cell(60, 5 ,my_utf8_decode($_POST['client_nom']));
		$this->Ln();
		...
		$this->SetFont('helvetica','',11);
		$this->Cell(90, 5 ,my_utf8_decode($_POST['artisan_representant']));

		// client adresse 1
		$this->SetFont('helvetica','I',11);
		$this->Cell(90, 5 ,my_utf8_decode($_POST['client_adresse']));
		$this->Ln();

		// client adresse 2
		$this->Cell(111);
		$this->Cell(60, 5 ,my_utf8_decode($_POST['client_adresse2']));
		$this->Ln();

		// client CP
		$this->SetFont('helvetica','',11);
		$this->Cell(111);
		$this->Cell(13, 5 ,my_utf8_decode($_POST['client_codepostal']));

		// client ville
		$this->Cell(60, 5 ,my_utf8_decode($_POST['client_ville']));
		$this->Ln();
		...
		// client tel 2
		$this->Cell(19);
		$this->Cell(60, 5 ,   my_utf8_decode($_POST['client_telephone2'])   );
		$this->Ln();
		...
		$this->SetFont('helvetica','',10);
		$this->Cell(21);
		$this->Cell(60, 5 ,my_utf8_decode($_POST['client_email']));
		$this->Ln(6);
