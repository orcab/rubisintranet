...
class PDF extends FPDF
{
	//EN-TÊTE
	function Header()
	{	global $titre_page,$old_style,$categorie,$row,$style ;
		//Logo
		//$this->Image('kspread.png',10,8,33);
		...
		$peres = explode('-',$row['chemin_complet']) ;
		$this->Cell(0,1, $titre_page ? $titre_page : $categorie['nom_'.$peres[0]] ,0,0,'L');
