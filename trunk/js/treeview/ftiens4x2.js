...
{ 
  ...
  this.iconImg = 0; 
  this.nodeImg = 0;
  this.iconSrc = ICONPATH + 'ftv2folderopen32px.png';
  this.iconSrcClosed = ICONPATH + 'ftv2folderclosed32px.png';
...
{ 
  ...
  if (this.level>0) 
    if (this.isLastNode) //the last child in the children array 
      ...
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "ftv2vertlinex2.png>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' border=0></a></td>"
  ...
  {
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "ftv2blankx2.png height=2 width=2>"
  }
  if (WRAPTEXT)
...
function nodeImageSrc() {
  ...
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "ftv2lastnodex2.png"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "ftv2mlastnodex2.png"  
      else
        srcStr = ICONPATH + "ftv2plastnodex2.png"  
  } 
  else 
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "ftv2nodex2.png"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "ftv2mnodex2.png"
      else
        srcStr = ICONPATH + "ftv2pnodex2.png"
  }   
  return srcStr;
}
...
function finalizeCreationOfItem(itemArray)
{
  ...
  itemArray.iconSrc = ICONPATH + "ftv2docx2.png" 
...
{ 
  ...
  if (this.level>0) 
    ...
    { 
      leftSide = leftSide + "<td valign=top><img src='" + ICONPATH + "ftv2lastnodex2.png'></td>"
    } 
    else 
    { 
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "ftv2vertlinex2.png><img src='" + ICONPATH + "ftv2nodex2.png'></td>"
    } 
  ...
  if (USEICONS)
	  ...
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "ftv2blankx2.png height=2 width=3>"
...
function leftSideHTML(leftSideCoded) {
	...
	for (i=0; i<leftSideCoded.length; i++)
	{
		...
		{
			retStr = retStr + "<td valign=top background=" + ICONPATH + "ftv2vertlinex2.png><img src='" + ICONPATH + "ftv2vertlinex2.png'></td>"
		}
		if (leftSideCoded.charAt(i) == "0")
		{
			retStr = retStr + "<td valign=top><img src='" + ICONPATH + "ftv2blankx2.png'></td>"
		}
	}
	return retStr
}
...
function preLoadIcons() {
       arImageSrc = new Array (
           ...
           "ftv2lastnodex2.png",
           "ftv2nodex2.png",
           "ftv2folderclosedx2.png",
           "ftv2folderopenx2.png",
           "ftv2docx2.png"
           )
