...
class PDF extends FPDF
{
	...
	{	global $row_entete,$vendeurs,$SOCIETE ;
		...
		$this->Image('gfx/'.LOGO_HAUT_GAUCHE,5,5,32);
		$this->Image('gfx/'.LOGO_HAUT_DROITE,PAGE_WIDTH - 27,7,22);
		...
		$this->Cell(27, 5 ,"Fournisseur :");
		$this->SetFont('helvetica','B',11);
		$this->Cell(100, 5 ,$row_entete['FNOMF']);
		
		// Date commande
		$this->SetFont('helvetica','B',11);
		$this->Cell(18, 5 ,"Cde du : ");
		$this->SetFont('helvetica','',11);
		$this->Cell(110, 5 , "$row_entete[CFEDJ]/$row_entete[CFEDM]/$row_entete[CFEDS]$row_entete[CFEDA]");
		$this->Ln();

		// N° de bon
		$this->SetFont('helvetica','BI',11);
		$this->Cell(17, 5 ,"N° Cde : ");
		$this->Cell(110, 5 ,$row_entete['CFBON']);

		// Date de livraison
		$this->SetFont('helvetica','B',11);
		$this->Cell(36, 5 ,"Date de livraison : ");
		$this->SetFont('helvetica','',11);
		...
		$this->Cell(0,5,"BON BON DE RETOUR / ATTENTE D'AVOIR",0,1,'C');
		$this->Ln(2);
	...
	{	global $row_entete,$SOCIETE ;
		...
		$this->RoundedRect(PAGE_WIDTH - RIGHT_MARGIN - 3, PAGE_HEIGHT - 19, 12, 6, 2, 'F');
		//Positionnement à 1,7 cm du bas
		$this->SetXY(PAGE_WIDTH - RIGHT_MARGIN,-20);
		$this->SetTextColor(255,255,255);
		$this->Cell(0,8,$this->PageNo().'/{nb}',0,1,'');
		$this->SetTextColor(0,0,0);
		$this->SetFont('helvetica','',9);
		$this->Cell(0,4,'le berry - 53470 Martigné sur Mayenne - Tél. 02 43 02 07 70 - Fax 02 43 02 07 63',0,1,'C');
		$this->SetFont('helvetica','',7);
		$this->Cell(0,4,'SA coopérative artisanale à Capital variable - Siret : 423 765 346 00030 - APE 4673A - N° TVA : FR 82 423 765 346',0,1,'C');
	}
