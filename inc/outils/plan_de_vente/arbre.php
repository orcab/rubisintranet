...
<style type="text/css">@import url(../../js/boutton.css);</style>
 ...
 <BODY topmargin="16" marginheight="16" style="margin-top:2px;">


<form name="rechercher" method="POST" action="affiche_article.php" style="margin-bottom:5px;" target="basefrm">
<input type="text" name="search_text" size="10"> <input type="submit" class="button valider" style="background-image:url(gfx/find.png);" value="Rechercher"><br>
<span style="font-size:0.7em;">(code, référence, désignation)</span>
</form>
